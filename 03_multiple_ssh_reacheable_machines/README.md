...
**Second, install jaynes** and other dependencies you need for your project. This tutorial is written w.r.t version: [v0.7.0](https://github.com/geyang/jaynes/releases/tag/v0.7.0)

```bash
pip install jaynes==0.7.0
```
