...
**Second, install jaynes** and other dependencies you need for your project. This tutorial is written w.r.t version: [v0.6.4](https://github.com/geyang/jaynes/releases/tag/v0.6.4)
